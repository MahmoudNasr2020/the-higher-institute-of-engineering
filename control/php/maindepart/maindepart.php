      ...
      <div class="main-panel">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">بيانات اقسام الصفحة الرئيسية</h4>
                        ...
                        <table class="table">
                          ...
                          <?php
                              foreach($fetchglobal as $fe=>$fetch){ ?>
                                                            <tr>
                              <td>
                                <img src="../../../uploads/depmain/<?php echo $fetch['img'] ?>" 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header text-center">
          <h4 class="modal-title w-100 font-weight-bold" id='h4'>اضافة قسم</h4>
        ...
        <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <form class="forms-sample" id='form-depart'>
                      <div class="form-group">
                          <div id='respons'></div>
                        </div>
                      <div class="form-group">
                          ...
                          name='name' placeholder="اسم القسم">
                        </div>
                        <div class="form-group">
                          <label for="exampleTextarea1">وصف القسم</label>
                          <textarea class="form-control" id="text" name='text'
                          rows="4"></textarea>
                        </div>
                        <div class="form-group">
                          <label id='text-img'>صورة القسم </label>
                          <input type="file" name="img" class="file-upload-default">
                          <div class="input-group col-xs-12">
                            <input type="text" class="form-control file-upload-info" id='file-img'
            ...
            $(document).on('click','.update-element',function(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                      ...
                      $('#type').val('update');
                      $('#id').val(data.id);
                      $('#text-img').text('صورة القسم (اختياري)');              
            ...
            $(document).on('click','.delete-element',function(){
                ...
                $.ajax({
                   ...
                   /*-------------------------------------------------------------------
                                                    Insert-update
                    --------------------------------------------------------------------*/
                    $('#form-depart').on('submit',function(e){
                      e.preventDefault();
                      $.ajax({
                          url:'insert.php',
                          method:'POST',
