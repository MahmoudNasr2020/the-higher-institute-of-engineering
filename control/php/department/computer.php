<?php 
   ...
   <footer class="footer">
    ...
    $selectabout=$con->prepare('SELECT * FROM aboutcom WHERE id = 1');
    $selectabout->execute();
    $fetchabout=$selectabout->fetch();
    $selectmessage=$con->prepare('SELECT * FROM commessage WHERE id = 1');
    $selectmessage->execute();
    $fetchmessage=$selectmessage->fetch();
    $selecttable=$con->prepare('SELECT * FROM comtable ORDER BY id DESC');
    $selecttable->execute();
    ...
    <div class="main-panel">
          ...
          <div class="row">
              <div class="col-12 grid-margin">
                ...
                <div class="card">
                  <div class="card-body">
                  <h4 class="card-title">قسم هندسة الحاسب</h4><br>
                    ...
                    <div class="table-responsive">
                      <table class="table table-about">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="../../../uploads/computer/<?php echo $fetchabout['img']; ?>" class="mr-2" alt="image"></td>
                            <td>
