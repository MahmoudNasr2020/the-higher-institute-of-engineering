  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
   ...
   if(empty($text)){
          ...
          $data['respons']='error';
              ...
              if($type=='update'){
                  $select=$con->prepare('SELECT img FROM aboutcom WHERE id=?');
              ...
              if($data['respons']=='success'){
                  if($task=='update'){
                      $update=$con->prepare('UPDATE aboutcom SET text=?,img=? WHERE id=?');
                  ...
                  $selectglobl=$con->prepare('SELECT * FROM aboutcom WHERE id=?');
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img src="../../../uploads/computer/'.$fetchglobal["img"].'" class="mr-2" alt="image"></td>
                      <td>
