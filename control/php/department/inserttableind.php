  ...
  exit();
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        --------------------------------------------------------------------------------------------*/
            ...
            if($type=='update'){
                $select=$con->prepare('SELECT img FROM indtable WHERE id=?');
           ...
           if(isset($data['update'])){
                    $update=$con->prepare('UPDATE indtable SET text=?,img=? WHERE id=?');
        ...
        if(isset($data['success'])){
            $insert=$con->prepare('INSERT INTO indtable(text,img) VALUES(?,?)');
        ...
        --------------------------------------------------------------------------------------------*/
        $global=$con->prepare('SELECT * FROM indtable ORDER BY id DESC');
        $global->execute();
