...
if($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 if(empty($text)){
        ...
        $data['respons']='error';
            ...
            if($type=='update'){
                $select=$con->prepare('SELECT img FROM aboutcivil WHERE id=?');
                ...
                if(empty($file)){
                    ...
                    elseif($file_size > 1000000){
                        ...
                        unlink("../../../uploads/civil/".$fetch['img']);
                        $myimg=rand(0,10000000000000).'.'.$image;
                        $folder='../../../uploads/civil/'.$myimg;
            ...
            if($data['respons']=='success'){
                if($task=='update'){
                    $update=$con->prepare('UPDATE aboutcivil SET text=?,img=? WHERE id=?');
                ...
                $selectglobl=$con->prepare('SELECT * FROM aboutcivil WHERE id=?');
                ...
                <tbody>
                  <tr>
                    <td>
                      <img src="../../../uploads/civil/'.$fetchglobal["img"].'" class="mr-2" alt="image"></td>
                    <td>
