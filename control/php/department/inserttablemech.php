  ...
  exit();
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        --------------------------------------------------------------------------------------------*/
            ...
            if($type=='update'){
                $select=$con->prepare('SELECT img FROM mechtable WHERE id=?');
           ...
           if(isset($data['update'])){
                    $update=$con->prepare('UPDATE mechtable SET text=?,img=? WHERE id=?');
        ...
        if(isset($data['success'])){
            $insert=$con->prepare('INSERT INTO mechtable(text,img) VALUES(?,?)');
        ...
        --------------------------------------------------------------------------------------------*/
        $global=$con->prepare('SELECT * FROM mechtable ORDER BY id DESC');
        $global->execute();
