  ...
  exit();
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        --------------------------------------------------------------------------------------------*/
            ...
            if($type=='update'){
                $select=$con->prepare('SELECT img FROM civiltable WHERE id=?');
           ...
           if(isset($data['update'])){
                    $update=$con->prepare('UPDATE civiltable SET text=?,img=? WHERE id=?');
        ...
        if(isset($data['success'])){
            $insert=$con->prepare('INSERT INTO civiltable(text,img) VALUES(?,?)');
        ...
        --------------------------------------------------------------------------------------------*/
        $global=$con->prepare('SELECT * FROM civiltable ORDER BY id DESC');
        $global->execute();
