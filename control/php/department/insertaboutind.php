  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
   ...
   if(empty($text)){
          ...
          $data['respons']='error';
              ...
              if($type=='update'){
                  $select=$con->prepare('SELECT img FROM aboutind WHERE id=?');
                  ...
                  if(empty($file)){
                      ...
                      elseif($file_size > 1000000){
                          ...
                          unlink("../../../uploads/industrial/".$fetch['img']);
                          $myimg=rand(0,10000000000000).'.'.$image;
                          $folder='../../../uploads/industrial/'.$myimg;
              ...
              if($data['respons']=='success'){
                  if($task=='update'){
                      $update=$con->prepare('UPDATE aboutind SET text=?,img=? WHERE id=?');
                  ...
                  $selectglobl=$con->prepare('SELECT * FROM aboutind WHERE id=?');
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img src="../../../uploads/industrial/'.$fetchglobal["img"].'" class="mr-2" alt="image"></td>
                      <td>
