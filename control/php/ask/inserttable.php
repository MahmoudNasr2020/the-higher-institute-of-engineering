...
if(!isset($_SESSION['email'])){
  ...
  if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    --------------------------------------------------------------------------------------------*/
        ...
        if($type=='update'){
            $update=$con->prepare('UPDATE question SET question=?,solution=?,date=? WHERE id=?');
        ...
        --------------------------------------------------------------------------------------------*/
            ...
            $insert=$con->prepare('INSERT INTO question(question,solution,date) VALUES(?,?,?)');
    ...
    --------------------------------------------------------------------------------------------*/
    $global=$con->prepare('SELECT * FROM question ORDER BY id DESC');
    $global->execute();
