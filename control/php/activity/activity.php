...
<?php 
    ...
    <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">قسم اتحاد الطلاب</h4>
                <div class="row">
                  <div class="col-12">
                    ...
                    <br><table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $fe['timeday']; ?></td>
                          <td>
                              <img src="../../../uploads/files/student/<?php echo $fe['img']; ?>" 
      ...
      <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleTextarea1">وصف الحدث </label>
