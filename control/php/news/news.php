...
<?php 
 ...
 <footer class="footer">
  ...
  $select=$con->prepare('SELECT * FROM news ORDER BY id DESC');
  $select->execute();
  ...
  <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">بيانات  الاخبار</h4>
              <div class="row">
                <div class="col-12">
                  ...
                  <br><table id="order-listing" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <img src="../../../uploads/news/<?php echo $fe['img'] ; ?>" 
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header text-center">
      <h4 class="modal-title w-100 font-weight-bold" id='h4'>اضافة خبر</h4>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputName1">عنوان الخبر</label>
                      <input type="text" class="form-control" id="title"  name ='title' placeholder="عنوان الخبر">
                    </div>
                  <div class="form-group">
