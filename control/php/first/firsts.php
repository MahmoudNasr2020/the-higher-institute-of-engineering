    ...
    <footer class="footer">
      ...
      <div class="main-panel">
            <div class="content-wrapper">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">اوائل الدفعات والاقسام</h4>
                  <div class="row">
                    <div class="col-12">
                       ...
                       <div class="form-group">
                          <div id='respnsv'></div>
                              ...
                              <button type="button" class="btn btn-primary btn-rounded mb-4" id='addnews' 
                                     data-toggle="modal" data-target="#modalSubscriptionForm">
                                            اضافة طالب جديد</button> <br>
                      ...
                      <br><table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <img src="../../../uploads/first/<?php echo $fe['img'] ; ?>" 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header text-center">
          <h4 class="modal-title w-100 font-weight-bold" id='h4'>اضافة طالب</h4>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputName1">اسم الطالب</label>
                          <input type="text" class="form-control" id="name"  name ='name' placeholder="اسم الطالب">
                        </div>
                      <div class="form-group">
                          <label for="exampleTextarea1">المركز</label>
                          <textarea class="form-control" id="exampleTextarea1" rows="4" name='arrangement' ></textarea>
                        </div>
                        <div class="form-group">
                          <label id='label'>رفع الصورة (اختياري)</label>
            ...
            $(document).on('click','.editnews',function(){
              ...
              $.ajax({
                 ...
                 success:function(data){
                    $('#exampleTextarea1').text(data.arrangement);
                    $('#name').val(data.name);
                    $('#type').val('update');
                    $('#id').val(data.id);
                    $('#h4').text('تعديل الطالب');
                    $('#respons').hide();
