...
<?php 
  ...
  <footer class="footer">
    ...
    $select=$con->prepare('SELECT * FROM result ORDER BY id DESC');
    $select->execute();
    ...
    <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">قسم النتيجة</h4>
                <div class="row">
                  <div class="col-12">
                     ...
                     <div class="form-group">
                        <div id='respnsv'></div>
                            ...
                            <button type="button" class="btn btn-primary btn-rounded mb-4" id='addres' 
                                   data-toggle="modal" data-target="#modalSubscriptionForm">
                                          اضافة نتيجة جديدة</button> <br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold" id='h4'>اضافة نتيجة</h4>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">الفرقة</label>
                        <input type="text" class="form-control" id="title"  name ='title' placeholder="اسم الفرقة">
                      </div>
                    <div class="form-group">
                        <label for="exampleTextarea1">وصف الملف </label>
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name='text' ></textarea>
                      </div>
                      <div class="form-group">
                        <label id='label'>رفع الملف</label>
