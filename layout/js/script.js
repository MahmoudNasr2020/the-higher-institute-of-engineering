(function ($) {
    ...
    $window.on('scroll', function () {
        if ($window.scrollTop() > 0) {
            ...
            $('.nav-brand img').attr('src', 'assets/img/core-img/logo2.png');
        } else {
            $('.header-area').removeClass('sticky');
            $('.nav-brand img').attr('src', 'assets/img/core-img/logo.png');
        }
    });
    ...
    if ($.fn.magnificPopup) {
        ...
        $('#iframbtn').magnificPopup({
            type: 'iframe'
        });
        $('#iframedevzone').magnificPopup({
            type: 'iframe'
        });
        $('#iframecodelink').magnificPopup({
            type: 'iframe'
        });
        $('#iframSuggest').magnificPopup({
            type: 'iframe'
        });
