...
$fetch=$select->fetch(); 
$select_about=$con->prepare('SELECT * FROM global ORDER BY id DESC ');
...
if($fetch['staute']==0){ ?>
    ...
    <html>
        <head>
            <link rel='shortcut icon' href="../layout/pattern/close.png">
             <title><?php $fetch['title']; ?> | القسم العام</title>
   ...
   <?php 
    ...
    $service='active';
    $title=$fetch['title'].' | القسم العام ';
    include 'inithead.php';
?>
<div class='page-content'>
    <div class="section-head text-center">
         <h3 class="title" style='padding-top: 58px;margin-bottom: -21px;'> القسم العام </h3>
    </div>
                    ...
                    <?php 
                        foreach($fetch_about as $fetch_abou=>$fetch_abo){ ?>
                             <div class="col-lg-4 col-md-6 col-sm-12">
                                <a href="../uploads/files/global/<?php echo $fetch_abo['img']; ?>" download="../uploads/files/global/<?php echo $fetch_abo['img']; ?>">
    							<div class="event-box">
    								<div class="event-media">
    									<img src="../uploads/files/global/1.webp" alt=""/>
    								</div>
