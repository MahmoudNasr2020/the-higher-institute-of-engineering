<?php 
    ...
    $fetch=$select->fetch(); 
	$select_table=$con->prepare('SELECT * FROM question');
		...
		<html>
			<head>
				<link rel='shortcut icon' href="../layout/pattern/close.png">
				 <title><?php $fetch['title']; ?> | قسم الاسئلة الشائعة</title>
	...
	$service='active';
    $title=$fetch['title'].' | الاسئلة الشائعة ';
    include 'inithead.php';
?>
<div class='page-content'>
    <div class="section-head text-center">
         <h3 class="title" style='padding-top: 58px;margin-bottom: -21px;'>  قسم الاسئلة الشائعة  </h3>
    </div>
